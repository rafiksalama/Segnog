# Segnog — Full Reference

## Contents

- [One Endpoint](#one-endpoint)
- [How it stays simple](#how-it-stays-simple)
- [Dashboard UI](#dashboard-ui)
- [Memory Architecture](#memory-architecture)
- [Two Memory Layers](#two-memory-layers)
- [The Observe Sequence](#the-observe-sequence)
- [3D Scoring](#3d-scoring)
- [The Ontology Layer](#the-ontology-layer)
- [Background Consolidation (REM)](#background-consolidation-rem)
- [Knowledge Extraction](#knowledge-extraction)
- [Benchmark — LoCoMo](#benchmark--locomo)
...
Toggle light/dark theme with the sun/moon button in the top-right corner. The preference is saved to `localStorage`.
